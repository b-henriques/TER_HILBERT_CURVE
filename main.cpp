...
int main(int argc, char* argv[])
{
	...
	std::vector<Point2D> points = Point2D::generatePoints(16, 0, 0, 10, 10);
	...
	HilbertCurve2D_Fixed hcf(points, 2, Point2D(0,0), Point2D(10,10), 8);
	HilbertCurve2D_Adaptive hc(points, 2, Point2D(0, 0), Point2D(10, 10));
